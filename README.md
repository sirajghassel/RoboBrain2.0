...
## 🗞️ News
- **`2025-09-29`**: 🤖 We released a unified cross(X)-embodiment VLA model [RoboBrain-X0-Preview](https://github.com/FlagOpen/RoboBrain-X0) based on RoboBrain 2.0 (3B version) on **CoRL 2025**.
